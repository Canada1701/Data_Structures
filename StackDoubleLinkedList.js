/* Name: Stack With Double Linked List Data Structure Implementation
 * Author: Brandon Bays
 * Date: May 4 / 2023
 * Description: Simple Stack with double linked list implementation
 *
 */
...
class Stack {
  ...
  push(data) {
    ...
    if (!this.first) { // If stack is empty
      ...
      temp.prev = newNode; // Set the previous pointer from old head to new head
